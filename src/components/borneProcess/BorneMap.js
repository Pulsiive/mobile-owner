...
import { View, Text, Alert, Modal, Pressable, Button, SafeAreaView, StyleSheet, PermissionsAndroid } from 'react-native';
...
const BorneMap = () => {
  ...
  const [userStation, setUserStation] = useState([
    {name: "Station 1", Type: "T2-EF", Pricing: 0.90, Voltage: 7, rating: 3, location: [2.362778, 48.815590]},
    {name: "Station 2", Type: "T2-EF", Pricing: 1.20, Voltage: 9, rating: 4, location: [2.372194, 48.811244]}
  ]);
  ...
  return (
    <View style={styles.page}>
      <View style={styles.container}>
        <MapboxGL.MapView style={styles.map} styleURL={nightMode ? "mapbox://styles/mapbox/dark-v9" : "mapbox://styles/mapbox/light-v9"} zoomLevel={16} center={[userPosition]}>
          <MapboxGL.Camera
            zoomLevel={13}
          ...
          <MapboxGL.PointAnnotation id={charger.name} coordinate={charger.location} onSelected={setModal}>
            <View>
              <Icon
                name='location-pin'
                size={24}
          ...
          <Pressable style={nightMode ? {backgroundColor: 'white', width: '11%', borderRadius: 15} : {backgroundColor: 'black', width: '11%', borderRadius: 15}} onPress={setMode}>
            <Icon
            name='moon'
            size={40}
          ...
          >
            <View style={styles.modal}>
              ...
              <Text style={{marginTop: '10%', marginLeft: '5%', fontSize: 20, fontWeight:'400'}}>{modalData.location}</Text>
